            ...
            <div class="lg:col-span-2 space-y-10 gsap-reveal">
                ...
                <div class="pt-6">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ $settings['social_whatsapp'] }}" target="_blank" aria-label="WhatsApp" class="w-12 h-12 rounded-xl bg-surface/50 border border-border flex items-center justify-center text-muted hover:text-primary hover:border-primary/50 transition-all hover:-translate-y-1 shadow-sm">

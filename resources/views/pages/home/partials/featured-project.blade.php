                        ...
                        <div class="relative z-10">
                            <div class="flex justify-between items-center mb-8">
                                ...
                                <div class="flex gap-3">
                                    @if($project->github)
                                    <a href="{{ $project->github }}" target="_blank" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted hover:text-primary hover:border-primary/50 transition-all">

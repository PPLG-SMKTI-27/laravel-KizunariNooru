        ...
        <div class="max-w-4xl mx-auto grid md:grid-cols-5 gap-8">
            ...
            <div class="md:col-span-2 space-y-4 gsap-reveal">
                ...
                @foreach([
                    ...
                    ['svg'=>'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>', 'label'=>'Location', 'val'=>'Fontaine, Indonesia 🇮🇩', 'href'=>'#'],
                    ['svg'=>'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"/>', 'label'=>'Response', 'val'=>'< 24 hours', 'href'=>'#'],
                ] as $c)
